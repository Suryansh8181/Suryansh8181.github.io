...
import Restaurants from "./italianRestaurants.json";
...
function Italian(){
    ...
    const usera=localStorage.getItem("italian");
    const userb=JSON.parse(usera)
    return(
        <>
        <NavigationBar />
        <div style={{ paddingTop: "8%" }}>
        <div style={{ marginLeft: '2rem' }} ><h3>Popular Italian Restraunts in {ucity}</h3></div>
       <div className='italian'  style={{display: 'flex',margin:'30px'}}>
