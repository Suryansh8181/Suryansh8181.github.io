...
import Restaurants from "./continentalRestaurants.json";
...
function Continental(){
    ...
    const usera=localStorage.getItem("continental");
    const userb=JSON.parse(usera)
    return(
        <>
        <NavigationBar />
        <div style={{ paddingTop: "8%" }}>
        <div style={{ marginLeft: '2rem' }} ><h3>Popular Continental Restraunts in {ucity}</h3></div>
       <div className='continental'  style={{display: 'flex',margin:'30px'}}>
